$('#select-perfil-meus-dados').select2({
    width: 99999
});

$('#cpf-meus-dados').mask('000.000.000-00');
$('#telefone-meus-dados').mask('(00) 0000-0000');//Aplicando máscara no telefone
$('#cep-meus-dados').mask('00000-000');
$('#data-contratacao-meus-dados').mask('00/00/0000');
$('#data-demissao-meus-dados').mask('00/00/0000');
$('#validade-cnh-meus-dados').mask('00/00');



function validarFormulario(){

    var cpf = document.querySelector("#cpf-meus-dados").value;
	var nome = document.querySelector("#nome-meus-dados").value;
    var apelido = document.querySelector("#apelido-meus-dados").value;
    var perfil = document.querySelector("#select-perfil-meus-dados").value;
    var email = document.querySelector("#email-meus-dados").value;
    var telefone = document.querySelector("#telefone-meus-dados").value;
    var senha = document.querySelector("#senha-meus-dados").value;
    var status = document.querySelector("#select-status-meus-dados").value;
    var imagem = document.querySelector("#imagem-meus-dados").value;
    var cep = document.querySelector("#cep-meus-dados").value;
    var endereco = document.querySelector("#endereco-meus-dados").value;
    var numero = document.querySelector("#numero-meus-dados").value;
    var complemento = document.querySelector("#complemento-meus-dados").value;
    var bairro = document.querySelector("#bairro-meus-dados").value;
    var cidade = document.querySelector("#cidade-meus-dados").value;
    var uf = document.querySelector("#uf-meus-dados").value;
    var salario = document.querySelector("#salario-meus-dados").value;
    var comissao = document.querySelector("#comissao-meus-dados").value;
    var statusComissao = document.querySelector("#select-status-comissao").value;
    var diaPagamento = document.querySelector("#dia-pagamento-meus-dados").value;
    var dataContratacao = document.querySelector("#data-contratacao-meus-dados").value;
    var dataDemissao = document.querySelector("#data-demissao-meus-dados").value;
    var cnh = document.querySelector("#cnh-meus-dados").value;
    var validadeCnh = document.querySelector("#validade-cnh-meus-dados").value;
    var placaVeiculo = document.querySelector("#placa-veiculo-meus-dados").value;
    var proprietarioVeiculo = document.querySelector("#proprietario-veiculo-meus-dados").value;
    var valorKm = document.querySelector("#valor-km-meus-dados").value;
...
const myDatePicker1 = MCDatepicker.create({ 
    el: '#data-contratacao-meus-dados',
