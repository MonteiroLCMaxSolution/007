                ...
                <div class="card-content">
                    <div class="row">
                        <div class="input-field col s10">
                            <input id="subcategoryName" type="text">
                            <label for="subcategoryName">Nome da Subcategoria</label>
                            <span class="helper-text">Pesquise pelo Nome</span>
                        </div>
                        <div class="col s1 left">
                            <br />
                            <a class="btn-floating waves-effect waves-light blue tooltipped" data-tooltip="Pesquisar" onclick="searchSubcategory()"><i class="material-icons">search</i></a>
                        </div>
                    </div>

                </div>

                <?php if ($ROW_Perm_Register_Subcategory->include == 'S') { ?>
                <a href="?pg=data-subcategory" class="btn-floating halfway-fab waves-effect waves-light green tooltipped" data-tooltip="Adicionar"><i class="material-icons">add</i></a>
                <?php } ?>
