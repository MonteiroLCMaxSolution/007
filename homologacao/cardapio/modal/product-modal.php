<div class="product-modal flexbox" id="product-modal">
    <div class="close-modal w100">
        <i class="fa-solid fa-xmark" onclick="closeProductModal()"></i>
    </div><!--close-modal-->
    <div class="product-modal-img w50" style="background-image: url(../images/coca3.jpg);"></div><!--product-modal-img-->
    <div class="product-modal-content w50">
        ...
        <div class="product-modal-add">
            <button>Adicionar R$ 7,00</button>
