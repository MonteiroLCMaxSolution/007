            ...
            <div class="card hoverable" style="border-top: 3px solid <?php echo $_SESSION['color']; ?>">
                ...
                <div class="card-content">
                    <div class="row">
                        ...
                        <?php if ($ROW_Perm_Register_Products->include == 'S') { ?>
                        <div class="col s1 left">
                            <br />
                            <a class="btn-floating waves-effect waves-light blue tooltipped" data-tooltip="Pesquisar" onclick="searchProduct()"><i class="material-icons">search</i></a>
                        </div>
                        <?php } ?>
                ...
                <a href="?pg=data-product" class="btn-floating halfway-fab waves-effect waves-light green tooltipped" data-tooltip="Adicionar"><i class="material-icons">add</i></a>
