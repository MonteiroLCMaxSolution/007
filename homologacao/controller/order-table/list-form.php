                            ...
                            <div class="card hoverable" style="height: 150px; background: <?php echo $cor;?>">
                                <div class="card-image">
                                   <!-- <img src="../../../MaxComanda/uploads/<?php echo $img_table;?>" style="max-height: 200px">-->
                                    <a class="btn-floating halfway-fab waves-effect waves-light green tooltipped" data-tooltip="Editar" href="?pg=order-table-form&t=<?php echo $row->id_mesa;?>&p=<?php echo $row->people;?>"><i class="material-icons">edit</i></a>
                                </div>
                                <div class="card-content">
