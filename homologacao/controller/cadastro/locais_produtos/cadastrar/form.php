    ...
    <div class="center">
        ...
        <form action=""  class="flexbox">
            ...
            <div class="inp-single w40">
                ...
                <input type="text" name="" id="nome-locais-produtos" placeholder="Nome da Localização" onkeyup="validarFormulario()">
            </div><!--inp-single-->
            <div class="inp-single w40">
                <p class="p-status">Status</p>
                <select name="" id="status-locais-produtos" onchange="validarFormulario()">
                    <option value="ativo">Ativo</option>
                    <option value="inativo">Inativo</option>
                </select>
            </div><!--inp-single-->
            <div class="buttons-box">
                <a href="<?= INCLUDE_PATH ?>?pg=listar-locais-produtos">Cancelar</a>
