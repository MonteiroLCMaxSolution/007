...
if ($directoryName == 'homologacao') {
  $lib = '..';
  $uploads = '../../../homologacao/uploads';
} else {
  $lib = '../../homologacao';
...
<body class="<?php echo $_SESSION['color']; ?> lighten-4">
  <input type="text" id="directory"   value="<?php echo $directoryName; ?>">
  <input type="text" id="http"   value="<?php echo $httpDirectory; ?>">
  <input type="text" id="lib"   value="<?php echo $lib; ?>">
  <input type="text" id="id_user"   value="<?php echo $_SESSION['id_user']; ?>">
  <input type="text" id="id_company"   value="<?php echo $_SESSION['id_company']; ?>">
  <input type="text" id="userProfile"  value="<?php echo $_SESSION['userProfile']; ?>">
  ...
  if (!isset($_SESSION['id_user']) && ($pg != 'cardapio' && $pg != 'delivery')) {
    header("Location: https://homologacao.com.br/" . $directoryName . "/");
