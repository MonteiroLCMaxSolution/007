...
// ************* LISTAR UNIQID PARA PUXAR OS PEDIDOS NA TELA DO BALCÃO - BRUNO R. BERNAL - 31/01/2022 *****

$listUniqID = "SELECT uniqID, table_delivery FROM order_items WHERE counter_status = 'Aguardando' GROUP BY table_delivery";
$listUniqID = $pdo->prepare($listUniqID);
$listUniqID->execute();

// ************* FIM - LISTAR UNIQID PARA PUXAR OS PEDIDOS NA TELA DO BALCÃO - BRUNO R. BERNAL - 31/01/2022 *****


// **************************** ENTREGAR PEDIDO - BRUNO R. BERNAL - 31/01/2022 ***************************
...
try {
	...
	$finishOrder = "UPDATE order_items SET counter_status = 'Entregue' WHERE id = :id";
	...
	$description = 'ITEM ENTREGUE NO BALCÃO';
	$sqlLog = "UPDATE order_items SET counter_status = 'Entregue' WHERE id = $id";
...
// **************************** FIM - ENTREGAR PEDIDO - BRUNO R. BERNAL - 31/01/2022 ***************************
